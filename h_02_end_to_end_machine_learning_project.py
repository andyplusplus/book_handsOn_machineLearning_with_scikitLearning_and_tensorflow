...
# However, the `OrdinalEncoder` class that is planned to be introduced in Scikit-Learn 0.20
# (see [PR #10521](https://github.com/scikit-learn/scikit-learn/issues/10521)) is preferable since it is designed for input features
#  (`X` instead of labels `y`) and it plays well with pipelines (introduced later in this notebook).
