...
# In[20]:
hidden_output, W1, b1, W4, b4 = train_autoencoder(mnist.train.images, n_neurons=300, n_epochs=min(n_epochs_min, 4), batch_size=150,
...
with tf.Session() as sess:
    saver.restore(sess, "./tmp/my_model_variational.ckpt")
    codings_val = codings.eval(feed_dict={X: X_test})
